                ...
                <div className="relative w-full h-[450px] sm:h-[550px] md:h-[700px]">
                        ...
                        {phases.map((phase, index) => (
                            <g key={phase.id}>
                                ...
                                <circle
                                    ...
                                    cy={phase.position.y}
                                    r="2"
                                    fill={lineProgress > (index / phases.length) ? '#FF1801' : 'rgba(255, 255, 255, 0.3)'}
                                    stroke={lineProgress > (index / phases.length) ? '#FF1801' : 'rgba(255, 255, 255, 0.5)'}
                                    strokeWidth="0.3"
                                    style={{
                                        filter: lineProgress > (index / phases.length)
                    ...
                    {phases.map((phase, index) => (
                        <motion.div
                            ...
                            className="absolute glass-morphism rounded-lg p-4 border border-white/10 hover:border-f1-red/50 transition-all duration-300 group"
                            style={{
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-f1-red/20 flex items-center justify-center font-racing text-f1-red group-hover:scale-110 transition-transform">
                                    {phase.id}
                                </div>
                                <div>
